...
* Support Symfony 8.0 and fix .phar php compatibility by @SRWieZ in https://github.com/whatsdiff/whatsdiff/pull/40
* Drop support for Symfony 6.0 deps

**Full Changelog**: https://github.com/whatsdiff/whatsdiff/compare/v2.1.0...v2.2.0
